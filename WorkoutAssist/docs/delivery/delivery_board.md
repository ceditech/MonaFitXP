...
_Board status reconciled with the codebase: 2026-07-18._
...
| **P1.0** | Exercise Demo Media | P1 | ✅ MVP Built | [x] Video Pipeline<br>[x] Fallback Chain | Low | QA, Arch | Detail-screen recording | Dev | Product | 15/20 videos, 20/20 infographics, detail carousel. **Web-verified only; ~12.9 MB bundled** |
...
- [ ] **Smoke**: Critical path (Auth → Workout → History) tested on device — **web-verified only; no native run yet**.
